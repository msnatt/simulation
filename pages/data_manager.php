            ...
            <div class="d-flex box" style="width: 50vw; height: 50vh;">
                <div class="" style="width: 60%;">
                    <div class="row">
                        ...
                        <?php include "../components/fetch_data.php"; ?>
                    </div>
                </div>
                <div style="width: 40%;">
                    <form action="../config/create_data.php" method="post" id="create_data" class="form-control h-100 w-100">
                        <div class="row mt-3">
                            <label class="text-center f-5 t-3 fw-bold">New Data</label>
                            <div class=" text-start align-self-center mt-4">
                                <label class="form-label t-2 f-2">Name</label>
                            </div>
                            <div class="">
                                <input id="input_create_data_id" name="input_create_data_id" class="form-control">
                            </div>
